window.$ = window.jquip = function () {
    function U(a, b) {
        var c;
        for (var e = 0, g = V.length; e < g; e++)if (V[e].apply(this, arguments))return this;
    ...
    function bf(a, b) {
        var b = " " + b + " ";
        for (var c = 0, d = a.length; c < d; c++)if (bg(a[c], b))return!0;
        return!1
    }
    ...
    function bm(a, b, c) {
        if (a == null)return;
        if (R && a.forEach === R)a.forEach(b, c); else if (a.length === +a.length) {
            for (var d = 0, e = a.length; d < e; d++)if (d in a && b.call(c, a[d], d, a) === K)return
        } else for (var f in a)if (N.call(a, f) && b.call(c, a[f], f, a) === K)return
    }
    ...
    function bp(a, b) {
        var c = [], d, e, f, g, h;
        for (d = 0, f = bo.length; d < f; d++)if (h = bo[d].exec(a))break;
        if (d < bo.length)for (e = 0; g = b[e]; e++)(d == 0 && h[1] == g.id || d == 1 && bz(h[1], g.tagName) || d == 2 && bg(g, h[1]) || d == 3 && h[2] == bn(g, h[1])) && c.push(g); else bl(a + " not supported");
        return c
    }
    ...
    function bw(a, b, c) {
        ...
        if (i)for (; g < h; g++)d = b(a[g], g, c), d != null && (f[f.length] = d); else for (e in a)d = b(a[e], e, c), d != null && (f[f.length] = d);
    ...
    function bJ(a, b) {
        var c = a.length, d = 0;
        if (typeof b.length == "number")for (var e = b.length; d < e; d++)a[c++] = b[d]; else while (b[d] !== undefined)a[c++] = b[d++];
        return a.length = c, a
    }
    ...
    function bK() {
        ...
        for (; i < j; i++)if ((a = g[i]) != null)for (b in a) {
            c = h[b], d = a[b];
            if (h === d)continue;
    ...
    function bO(a, b, c) {
        var d = [], e, f;
        for (e = 0; (f = a[e]) != null; e++)bB(f) && (f = bN(f, b)), f.nodeType ? d.push(f) : d = bJ(d, f);
    ...
    var a = window, b = "http://cdnjs.cloudflare.com/ajax/libs/sizzle/1.4.4/sizzle.min.js", c = function () {
    ...
    $ = U.prototype = _.prototype = _.fn = {constructor:_, selector:"", length:0, dm:function (a, b, c) {
        ...
        return bB(a) && b === undefined ? bn(c, a) : this.each(function (c) {
            var d = this.nodeType;
            if (d !== 3 && d !== 8 && d !== 2)if (bC(a))for (var e in a)b === null ? this.removeAttribute(a) : this.setAttribute(e, a[e]); else this.setAttribute(a, bD(b) ? b.call(this, c, this.getAttribute(a)) : b)
        })
        ...
        if (!bB(a))return _(a).filter(function () {
            for (c = 0, d = b.length; c < d; c++)if (A(b[c], this))return!0
        });
        ...
        for (var a = 0, b; (b = this[a]) != null; a++)b.parentNode && b.parentNode.removeChild(b);
        return this
        ...
        for (var a = 0, b; (b = this[a]) != null; a++)while (b.firstChild)b.removeChild(b.firstChild);
        return this
    }, $.addClass = function (a) {
        var b, c, d, e, f, g, h;
        ...
        if (a && bB(a)) {
            ...
            for (c = 0, d = this.length; c < d; c++) {
                e = this[c];
                if (e && e.nodeType === 1)if (!e.className && b.length === 1)e.className = a; else {
                    f = " " + e.className + " ";
    ...
    return A = _.contains = e.contains ? function (a, b) {
        ...
        for (var j = 0; j < c && j < d; j++)if (e[j] !== f[j])return bP(e[j], f[j]);
...
$.plug("events", function (a) {
    ...
    var b = document, c = {}, d = 1;
    a.bind = f, a.unbind = g;
    var m = ["preventDefault", "stopImmediatePropagation", "stopPropagation"], o = a.fn;
    a._each("blur focus focusin focusout load resize scroll unload click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup error".split(" "), function (a) {
        o[a] = function (b, c) {
        ...
        return this.each(function () {
            var c = this;
            k(this, a, function () {
                b(), l(c, a, arguments.callee)
            })
        })
    }, o.delegate = function (b, c, d) {
        return this.each(function (e, f) {
            k(f, c, d, b, function (c) {
                var e = c.target, g = a.$$(b, f);
                while (e && g.indexOf(e) < 0)e = e.parentNode;
                e && e !== f && e !== document && d.call(e, a.extend(n(c || window.event), {currentTarget:e, liveFired:f}))
            })
        })
    ...
    function j(b) {
        ...
        if (!h || b !== !0 && !g) {
            ...
            if (f) {
                var d, e = 0, i = f;
                f = null;
                while (d = i[e++])d.call(c, a);
                a.fn.trigger && a(c).trigger("ready").unbind("ready")
            }
        }
    }

    var b = window, c = document, d, e, f = [], g = !1, h = 1;
    a.hook(function (a, b) {
        if (typeof a == "function")return this.ready(a), !0
    }), a.ready = j, d = c.addEventListener ? function () {
        c.removeEventListener("DOMContentLoaded", d, !1), j()
    } : function () {
        c.readyState === "complete" && (c.detachEvent("onreadystatechange", d), j())
    }, a.bindReady = function () {
        if (e)return;
        e = !0;
        if (c.readyState === "complete")return setTimeout(j, 1);
...
$.plug("css", function (a) {
    ...
    a.fn.offset = function () {
        ...
        if (!e || !a.contains(c, d))return e ? {top:e.top, left:e.left} : {top:0, left:0};
...
$.plug("ajax", function ($) {
    function _xhr() {
        ...
        for (var a = 0, b = xhrs.length; a < b; a++)try {
            var c = xhrs[a], d = c();
            if (d != null)return _xhrf = c, d
        } catch (e) {
        }
        return function () {
        }
    ...
    function _xhrResp(xhr, dataType) {
        return dataType = (dataType || xhr.getResponseHeader("Content-Type").split(";")[0]).toLowerCase(), dataType.indexOf("json") >= 0 ? window.JSON ? window.JSON.parse(xhr.responseText) : eval(xhr.responseText) : dataType.indexOf("script") >= 0 ? eval(xhr.responseText) : dataType.indexOf("xml") >= 0 ? xhr.responseXML : xhr.responseText
    }

    function ajax(a, b) {
        var c = _xhr(), d, e = 0;
        typeof a == "object" ? b = a : b.url = a, b = $._defaults(b, {userAgent:"XMLHttpRequest", lang:"en", type:"GET", data:null, contentType:"application/x-www-form-urlencoded", dataType:null, processData:!0, headers:{"X-Requested-With":"XMLHttpRequest"}}), b.timeout && (d = setTimeout(function () {
            c.abort(), b.timeoutFn && b.timeoutFn(b.url)
        }, b.timeout));
        var f = $(b.context || document), g = f;
        c.onreadystatechange = function () {
            if (c.readyState == 4) {
                d && clearTimeout(d);
                if (c.status < 300) {
                    var a = _xhrResp(c, b.dataType);
                    b.success && b.success(a), g.trigger("ajaxSuccess", [c, a, b])
        ...
        var a = b.url, h = null, i = b["type"] == "POST" || b["type"] == "PUT";
        b.data && b.processData && typeof b["data"] == "object" && (h = $.formData(b.data)), !i && h && (a += "?" + h), c.open(b.type, a);
        try {
            for (var j in b.headers)c.setRequestHeader(j, b.headers[j])
        } catch (k) {
            console.log(k)
        }
        i && c.setRequestHeader("Content-Type", b.contentType), c.send(h)
    }
    ...
    $.xhr = _xhr, $._xhrResp = _xhrResp, $.formData = function (a) {
        var b = [], c = /%20/g;
        for (var d in a)b.push(encodeURIComponent(d).replace(c, "+") + "=" + encodeURIComponent(a[d].toString()).replace(c, "+"));
        return b.join("&")
        ...
        $.isFunction(b) && (d = c, c = b, b = null), ajax({url:a, type:"GET", data:b, success:c, dataType:d || "text/plain"})
    }, $.post = function (a, b, c, d) {
        $.isFunction(b) && (d = c, c = b, b = null), ajax({url:a, type:"POST", data:b, success:c, dataType:d || "text/plain"})
    }, $.getScript = function (a, b) {
        return $.get(a, undefined, b, "script")
